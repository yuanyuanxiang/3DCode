...
参数：3
	int NewWidth：新图像宽度
	int NewHeight：新图像高度
	int bNeededReturn：需要返回新图像数据块头指针
返回值：新图像数据块头指针
*/
